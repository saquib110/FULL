...
public class ViewBySize extends AppCompatActivity implements ViewStrategy{
    private static String URL  ="http://192.168.1.103/saquibfull/productsize.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_by_size);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET,
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Picasso.with(ViewBySize.this).load(productList.get(0).imageURL).into(image1);
                        ...
                        Picasso.with(ViewBySize.this).load(productList.get(1).imageURL).into(image2);
                    }
                },
    ...
    public void doOperation(Context context) {
        Intent myIntent = new Intent(context, ViewBySize.class);
